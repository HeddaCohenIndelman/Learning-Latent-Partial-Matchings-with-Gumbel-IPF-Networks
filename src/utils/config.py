...
__C.OPTIMIZATION_METHOD = 'Sinkhorn' #Direct or Sinkhorn or superglue
__C.MATCHING_TYPE = 'Unbalanced'
__C.filter_type = 'NoFilter'
__C.ipf = True
__C.ipf_on_pred = True
__C.prediction_type = 'normonpred' #'normonpred' or 'norelaxation'
__C.epsilon_approx = 1e-6
__C.loss_epsilon = 3*1e-5
__C.pos_weight = 10
__C.train_noise_factor = False
__C.sigma_norm = 32
__C.sigma_decay = 0.01
__C.samples_per_num_train = 1
__C.exclude_overlapping_Willow = False
__C.calc_pred_shift = False
__C.calc_MAE = False

__C.normalize_gnn_outputs_channles = False # v = normalize_over_channels(v)
