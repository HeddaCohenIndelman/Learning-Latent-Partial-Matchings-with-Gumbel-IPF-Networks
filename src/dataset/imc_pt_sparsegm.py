...
class IMC_PT_SparseGM(BaseDataset):
    ...
    def get_pair(self, cls=None, shuffle=True, tgt_outlier=False, src_outlier=False):
        ...
        '''
        with open('imcpt_imbalance.txt','a') as im_file:
    ...
    def __get_anno_dict(self, img_name, cls):
        ...
        img_file = self.root_path_img / self.classes[cls] / img_name
        npz_file = self.root_path_npz / self.classes[cls] / (img_name[:-4] + '.npz')
